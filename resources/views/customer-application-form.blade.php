                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control @error('first_name') is-invalid
                                        
                                                        @enderror" placeholder="Enter First Name" id="first_name">
                                                </div>
                                                @error('first_name')
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter Middle Name" name="last_name" value="{{ old('last_name') }}" class="form-control @error('last_name') is-invalid
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="surname" value="{{ old('surname') }}" class="form-control @error('surname') is-invalid
                                        
                                                        @enderror" placeholder="Enter Surname">
                                                </div>
                                                @error('surname')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="email" class="form-control @error('email') is-invalid
                                                        ...
                                                        @enderror" value="{{ old('email') }}" placeholder="Enter Email Address">
                                                </div>
                                                @error('email')
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="mobile_no" value="{{ old('mobile_no') }}" class="form-control @error('mobile_no') is-invalid
                                        
                                                        @enderror" placeholder="Enter Mobile No">
                                                </div>
                                                @error('mobile_no')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Mobile Number" name="alternate_mobile_no" value="{{ old('alternate_mobile_no') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="address" class="form-control @error('address') is-invalid
                                        
                                                        @enderror" placeholder="Enter your Address">{{ old('address') }}</textarea>
                                                </div>
                                                @error('address')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Pincode</label>
                                                    <input type="number" class="form-control" placeholder="Enter Pincode" name="pincode" value="{{ old('pincode') }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group service-upload logo-upload mb-0">
                                                        <span><img src="{{ asset('assets/img/icons/img-drop.svg') }}" alt="upload"></span>
                                                        <div class="drag-drop">
                                                            ...
                                                            <input type="file" multiple id="image_sign" name="adhar_card_file">
                                                            <div id="frames"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="basicpill-pancard-input" class="form-label">Finance
                                                        Name</label>
                                                    <input type="text" class="form-control" id="basicpill-pancard-input" placeholder="Enter Finance Name" name="finance_name"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Executive Name" name="executive_name" value="{{ old('executive_name') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-label">Dealer Name</label>
                                                    <input type="text" class="form-control" placeholder="Enter Dealer Name" name="Dealer_name" value="{{ old('Dealer_name') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Vehicle Type" name="vehicle_type" value="{{ old('vehicle_type') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Vehicle Registration Number" name="vehicle_registration_no"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Registration Year" name="vehicle_registration_year"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Chasis Number" name="chasis_no" value="{{ old('chasis_no') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Engine Number" name="engine_no" value="{{ old('engine_no') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Fuel Type</label>
                                                    <input type="text" class="form-control" placeholder="Enter Fuel Type" name="fuel_type" value="{{ old('fuel_type') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Insurance Company Name" name="insurance_company_name"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group service-upload logo-upload mb-0">
                                                        ...
                                                        <div class="drag-drop">
                                                            ...
                                                            <input type="file" multiple id="rc_book" name="rc_book">
                                                            <div id="frames"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group service-upload logo-upload mb-0">
                                                        ...
                                                        <div class="drag-drop">
                                                            ...
                                                            <input type="file" multiple id="insurance_file" name="insurance_file">
                                                            <div id="frames"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <table class="table table-borderless text-end mb-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Loan Amount </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="number" class="form-control " id="loan-amount" name="loan_amount" value="{{ old('loan_amount') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Interest Rate (%) </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="number" class="form-control " id="interest-rate" name="interest_rate" value="{{ old('interest_rate') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Loan Term (Months) </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="number" class="form-control " id="loan-term" name="loan_term" value="{{ old('loan_term') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>EMI </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="number" class="form-control " id="emi-result" name="emi" value="{{ old('emi') }}" readonly>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Loan Suraksha Vimo </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="loan-suraksha-vimo" name="loan_surakhya_vimo"
                                                                        ...
                                                                        <tr>
                                                                            <th>IHO </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="iho" name="iho" value="{{ old('iho') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Total File Charge </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="cutoff-fee" name="file_charge" value="{{ old('file_charge') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Road Side Assite </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="road-side-assite" name="road_side_assite"
                                                                        ...
                                                                        <tr>
                                                                            <th>RTO </th>
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="rto" name="rto_charge" value="{{ old('rto_charge') }}">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <th class="dotted">:</th>
                                                                            <td><input type="text" class="form-control " id="hold-for-insurance" name="hold_for_insurance"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="dotted">:</th>
                                                                            <td>
                                                                                <textarea class="form-control" id="loan_detail_remark"
                                                                                    name="remark_loan_detail">{{ old('remark_loan_detail') }}</textarea>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="ps-0 pt-0 pb-4">
                                                                                <hr class="mb-3 mt-0">
                                                                                <h5 class="text-primary"><span id="total-remaining">0</span>
                                                                                </h5>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Account Holder Name" name="bank_account_holder_name"
                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Account Number" name="account_no" value="{{ old('account_no') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Bank Name</label>
                                                    <input type="text" class="form-control" placeholder="Enter Bank Name" name="bank_name" value="{{ old('bank_name') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter IFSC Code" name="ifsc_code" value="{{ old('ifsc_code') }}">
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" name="modal_village_name" id="modal_village_name" class="form-control" placeholder="Enter Village Name">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group mb-0">
